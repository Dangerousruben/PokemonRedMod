...
DebugData:
	db $FF, 6, CATERPIE, SPLASH, STRUGGLE, WATER_GUN, BIDE, 7, WEEDLE, 0

BugCatcherData:
; Viridian Forest
	db $FF, 1, PINSIR, $F4, STRUGGLE, SPLASH, $F4, 3, CATERPIE, $F4, SPLASH, STRUGGLE, $F4, 3, CATERPIE, $F4, SPLASH, STRUGGLE, $F4, 0
	;db $FA, 7, PINSIR, 3, CATERPIE, 0
